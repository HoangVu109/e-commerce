...
namespace E_commerce.Migrations
{
    ...
    [Migration("20260628210612_AddChatSupport")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("E_commerce.Models.ChatSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("E_commerce.Models.ChatMessage", b =>
                {
                    b.HasOne("E_commerce.Models.User", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("E_commerce.Models.ChatSession", "Session")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("E_commerce.Models.ChatSession", b =>
                {
                    b.HasOne("E_commerce.Models.User", "Customer")
                        .WithMany()
